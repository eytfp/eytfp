...
2. Burp 加载插件：
    ...
    - 加载类型选`Java`，选择下载的`CaA\.jar`，点击`Next`
      ...
      ![image-20260515132837283](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515132837283.png)

3. 加载成功：Burp 新增`CaA`标签页，首次加载自动生成数据库、配置文件

    ![image-20260515133032470](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515133032470.png)

    发现出现这个就是安装成功

    ![image-20260515133131481](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515133131481.png)
...
![image-20260515144540749](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515144540749.png)

**但是你会在目标中看到如下信息，全部记录都被记录下来了，当你使用DataBoard搜索127.0.0.1:8080时，它会将这些网页的1敏感信息什么的都一次性提取出来**



![image-20260515144727816](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515144727816.png)
...
![image-20260515145817827](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515145817827.png)
...
![image-20260515150606488](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515150606488.png)

**找到Generator，这里是生成payload，并且这种payload是给Burp suite自带的intrude用的**

![image-20260515150900689](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515150900689.png)

当我们生成payload后，我们来到intrude，然后选择如图所示的配置

![image-20260515151135685](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515151135685.png)



![image-20260515151831081](https://gitee.com/lkw01/image-host/raw/master/img/image-20260515151831081.png)
